...
并非所有 IDE 都同等支持 AIOS 功能。请参阅 [`docs/ide-integration.md`](./ide-integration.md) *(coming soon)* 中的完整比较。
...
- **[棕地项目工作指南](.aios-core/working-in-the-brownfield.md) *(coming soon)*** - 完整的棕地项目文档
- **[兼容性检查清单](.aios-core/development/checklists/brownfield-compatibility-checklist.md) *(coming soon)*** - 迁移前/后检查
- **[风险报告模板](.aios-core/product/templates/brownfield-risk-report-tmpl.yaml) *(coming soon)*** - 分阶段风险评估
...
请参阅[用户指南](./guides/user-guide.md) *(coming soon)*了解完整工作流。

### 小队扩展

小队将 AIOS 扩展到软件开发之外的任何领域。请参阅[小队指南](./guides/squads-guide.md) *(coming soon)*。
...
- **[用户指南](./guides/user-guide.md) *(coming soon)*** - 从规划到交付的完整工作流
- **[IDE 集成](./ide-integration.md) *(coming soon)*** - 每个 IDE 的详细设置
- **[架构](./architecture/ARCHITECTURE-INDEX.md)** - 技术深度解析
- **[小队指南](./guides/squads-guide.md) *(coming soon)*** - 将 AIOS 扩展到任何领域
