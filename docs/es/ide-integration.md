...
special_features:
  ...
  - Agentes canonicos en .antigravity/agents
```
...
3. Los agentes se sincronizan en:
   - `.agent/workflows/*.md` para activacion
   - `.antigravity/agents/*.md` como definiciones canonicas
   - `.antigravity/rules.md` para reglas globales
