...
> 🌐 [EN](../agent-reference-guide.md) *(coming soon)* | **PT** | [ES](../es/agent-reference-guide.md)
...
- [Diagrama de Workflow](../guides/hybridOps/workflow-diagram.md) *(coming soon)* - Representação visual do workflow de 9 fases
- [Workflow YAML](../guides/hybridOps/hybrid-ops-pv.yaml) *(coming soon)* - Configuração de orquestração de workflow
