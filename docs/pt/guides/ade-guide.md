...
- [ADE Architect Handoff](../../architecture/ADE-ARCHITECT-HANDOFF.md) *(coming soon)* - Visão geral
...
- [Epic 2 - Migração V2→V3](../../architecture/ADE-EPIC2-HANDOFF.md) *(coming soon)*
