...
> **PT** | [EN](../architecture/multi-repo-strategy.md) | [ES](../es/architecture/multi-repo-strategy.md) *(coming soon)*
...
- [Guia de Migração v2.0 para v4.0.4](../migration/migration-guide.md) *(coming soon)*
