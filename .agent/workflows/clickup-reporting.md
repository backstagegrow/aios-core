---
description: Ativa o agente Clickup-reporting
---

# Ativacao do Agente Clickup-reporting

**INSTRUCOES CRITICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `.antigravity/agents/clickup-reporting.md`
