...
`;
  ...
  describe('Cache Mechanism', () => {
    test('should cache tool after first resolution', async () => {
      // Mock file system
      fg.sync.mockReturnValue(['aios-core/tools/test-simple.yaml']);
  ...
  describe('Schema Validation', () => {
    test('should validate required fields', async () => {
      fg.sync.mockReturnValue(['aios-core/tools/invalid.yaml']);
    ...
    test('should validate v1.0 tool schema', async () => {
      fg.sync.mockReturnValue(['aios-core/tools/simple.yaml']);
      fs.readFile.mockResolvedValue(simpleToolYaml);
    ...
    test('should validate v2.0 tool schema with executable knowledge', async () => {
      fg.sync.mockReturnValue(['aios-core/tools/complex.yaml']);
    ...
    test('should reject invalid YAML syntax', async () => {
      fg.sync.mockReturnValue(['aios-core/tools/broken.yaml']);
...
`;
      ...
      fg.sync.mockReturnValue(['aios-core/tools/auto.yaml']);
...
`;
      ...
      fg.sync.mockReturnValue(['aios-core/tools/api.yaml']);
...
`;
      ...
      fg.sync.mockReturnValue(['aios-core/tools/anti.yaml']);
...
`;
      ...
      fg.sync.mockReturnValue(['aios-core/tools/health.yaml']);
...
`;
      ...
      fg.sync.mockReturnValue(['aios-core/tools/http-health.yaml']);
...
`;
      ...
      fg.sync.mockReturnValue(['aios-core/tools/function-health.yaml']);
